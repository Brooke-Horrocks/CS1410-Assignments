...
public class ListVsSetGui extends JFrame {
	...
	private JPanel createDemoPanel() {
		...
		rdbtnListElements.addActionListener(new ActionListener() {
			// Set text field to display List elements
		...
		rdbtnSetElements.addActionListener(new ActionListener() {
			// Set text field to display Set elements
			public void actionPerformed(ActionEvent e) {
		...
		rdbtnAddElement.addActionListener(new ActionListener() {
			// Add element to both List and Set
			public void actionPerformed(ActionEvent e) {
				demo.addElement(new ColoredSquare(10, Color.ORANGE));
				// Display element added validation message
				JOptionPane.showMessageDialog(controlPanel, "Element Added","Alert",JOptionPane.WARNING_MESSAGE);
			}
		});
	...
	private JPanel createMainDifferencePanel() {
		...
		txtrTheMain.setText("The 2 main differences between interface List and Set are:\n"
				+ "\n-- Set will not have duplicates while List will."
				+ "\n-- Set does not have positional access while List does.");
